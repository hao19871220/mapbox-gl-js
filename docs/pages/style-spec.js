                ...
                <div className='limiter clearfix'>
                    ...
                    <div className='contain margin3 col9'>
                        ...
                        <div className='pad2 prose'>
                            ...
                            <p>A <em>data expression</em> is any expression that uses one of the data operators:
                                ...
                                feature's properties to determine its appearance. They can be used to visually differentate
                                different features within the same layer and to create data visualizations.</p>
                            ...
                            <p>A single expression may use both data operators and camera operators, as well as any other
                                operators. Such <em>composite</em> expressions allows a layer's appearance to be determined
                                by a combination of the zoom level <em>and</em> individual feature properties.</p>
                            ...
                            <p>A composite expression must adhere to the restrictions described above for data and
                                camera expressions.</p>
